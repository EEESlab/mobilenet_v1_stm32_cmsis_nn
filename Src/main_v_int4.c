...
int main(void)
{
	...
	while(1) {
		...
		*/
		USR_CC_ENABLE();
		USR_CC_RESET();
		arm_convolve_HWC_u8_u4_u4(tensorIn, CONV1_IM_DIM, CONV1_IM_CH, conv1_wt, CONV1_OUT_CH, CONV1_KER_DIM, CONV1_L_PADDING, CONV1_R_PADDING, CONV1_T_PADDING, CONV1_B_PADDING, CONV1_STRIDE, conv1_bias, tensorOut, CONV1_OUT_DIM, CONV1_IN_Z, CONV1_W_Z, CONV1_OUT_Z, CONV1_M_ZERO, CONV1_N_ZERO, l1_tensor_scratch, NULL);
		...
		*Cycle =
		*/
		arm_convolve_HWC_u4_u4_u4(tensorIn, CONV3_IM_DIM, CONV3_IM_CH, conv3_wt, CONV3_OUT_CH, CONV3_KER_DIM, CONV3_L_PADDING, CONV3_R_PADDING, CONV3_T_PADDING, CONV3_B_PADDING, CONV3_STRIDE, conv3_bias, tensorOut, CONV3_OUT_DIM, CONV3_IN_Z, CONV3_W_Z, CONV3_OUT_Z, CONV3_M_ZERO, CONV3_N_ZERO, l1_tensor_scratch, NULL);
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		...
		*Cycle =
		*/
		arm_convolve_HWC_u4_u4_u4(tensorIn, CONV5_IM_DIM, CONV5_IM_CH, conv5_wt, CONV5_OUT_CH, CONV5_KER_DIM, CONV5_L_PADDING, CONV5_R_PADDING, CONV5_T_PADDING, CONV5_B_PADDING, CONV5_STRIDE, conv5_bias, tensorOut, CONV5_OUT_DIM, CONV5_IN_Z, CONV5_W_Z, CONV5_OUT_Z, CONV5_M_ZERO, CONV5_N_ZERO, l1_tensor_scratch, NULL);
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		...
		*Cycle =
		*/
		arm_convolve_HWC_u4_u4_u4(tensorIn, CONV7_IM_DIM, CONV7_IM_CH, conv7_wt, CONV7_OUT_CH, CONV7_KER_DIM, CONV7_L_PADDING, CONV7_R_PADDING, CONV7_T_PADDING, CONV7_B_PADDING, CONV7_STRIDE, conv7_bias, tensorOut, CONV7_OUT_DIM, CONV7_IN_Z, CONV7_W_Z, CONV7_OUT_Z, CONV7_M_ZERO, CONV7_N_ZERO, l1_tensor_scratch, NULL);
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		...
		*Cycle =
		*/
		arm_convolve_HWC_u4_u4_u4(tensorIn, CONV9_IM_DIM, CONV9_IM_CH, conv9_wt, CONV9_OUT_CH, CONV9_KER_DIM, CONV9_L_PADDING, CONV9_R_PADDING, CONV9_T_PADDING, CONV9_B_PADDING, CONV9_STRIDE, conv9_bias, tensorOut, CONV9_OUT_DIM, CONV9_IN_Z, CONV9_W_Z, CONV9_OUT_Z, CONV9_M_ZERO, CONV9_N_ZERO, l1_tensor_scratch, NULL);
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		...
		*Cycle =
		*/
		arm_convolve_HWC_u4_u4_u4(tensorIn, CONV11_IM_DIM, CONV11_IM_CH, conv11_wt, CONV11_OUT_CH, CONV11_KER_DIM, CONV11_L_PADDING, CONV11_R_PADDING, CONV11_T_PADDING, CONV11_B_PADDING, CONV11_STRIDE, conv11_bias, tensorOut, CONV11_OUT_DIM, CONV11_IN_Z, CONV11_W_Z, CONV11_OUT_Z, CONV11_M_ZERO, CONV11_N_ZERO, l1_tensor_scratch, NULL);
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		...
		*Cycle =
		*/
		arm_convolve_HWC_u4_u4_u4(tensorIn, CONV15_IM_DIM, CONV15_IM_CH, conv15_wt, CONV15_OUT_CH, CONV15_KER_DIM, CONV15_L_PADDING, CONV15_R_PADDING, CONV15_T_PADDING, CONV15_B_PADDING, CONV15_STRIDE, conv15_bias, tensorOut, CONV15_OUT_DIM, CONV15_IN_Z, CONV15_W_Z, CONV15_OUT_Z, CONV15_M_ZERO, CONV15_N_ZERO, l1_tensor_scratch, NULL);
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		...
		*Cycle =
		*/
		arm_convolve_HWC_u4_u4_u4(tensorIn, CONV21_IM_DIM, CONV21_IM_CH, conv21_wt, CONV21_OUT_CH, CONV21_KER_DIM, CONV21_L_PADDING, CONV21_R_PADDING, CONV21_T_PADDING, CONV21_B_PADDING, CONV21_STRIDE, conv21_bias, tensorOut, CONV21_OUT_DIM, CONV21_IN_Z, CONV21_W_Z, CONV21_OUT_Z, CONV21_M_ZERO, CONV21_N_ZERO, l1_tensor_scratch, NULL);
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		...
		*Cycle =
		*/
		arm_convolve_HWC_u4_u4_u4(tensorIn, CONV23_IM_DIM, CONV23_IM_CH, conv23_wt, CONV23_OUT_CH, CONV23_KER_DIM, CONV23_L_PADDING, CONV23_R_PADDING, CONV23_T_PADDING, CONV23_B_PADDING, CONV23_STRIDE, conv23_bias, tensorOut, CONV23_OUT_DIM, CONV23_IN_Z, CONV23_W_Z, CONV23_OUT_Z, CONV23_M_ZERO, CONV23_N_ZERO, l1_tensor_scratch, NULL);
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
		...
		*Cycle =
		*/
		arm_convolve_HWC_u4_u4_u4(tensorIn, CONV27_IM_DIM, CONV27_IM_CH, conv27_wt, CONV27_OUT_CH, CONV27_KER_DIM, CONV27_L_PADDING, CONV27_R_PADDING, CONV27_T_PADDING, CONV27_B_PADDING, CONV27_STRIDE, conv27_bias, tensorOut, CONV27_OUT_DIM, CONV27_IN_Z, CONV27_W_Z, CONV27_OUT_Z, CONV27_M_ZERO, CONV27_N_ZERO, l1_tensor_scratch, NULL);
		USR_GET_CC_TIMESTAMP(cpu_cycles[layerId]);
