...
volatile unsigned int cpu_cycles[2];
...
int main()
{
	...
	volatile int32_t pippo;
	volatile uint32_t m_zero;
	volatile uint32_t n_zero;

	pippo = 100;
	m_zero = 0x80000000;
	n_zero = 33;

	volatile int32_t out = (pippo*m_zero) >> n_zero;


	uint8_t *l1_tensor_scratch;

	// tensorIn starts on top of the L2 scratch mem
	// tensorOut is alligned to the bottom of the L2 scratch mem
	int 	tensorId = 0;
	...
	for (int i=0;i<CONV1_IM_CH * CONV1_IM_DIM * CONV1_IM_DIM; i++)
		tensorIn[i] = (uint8_t)image_data[i];
	...
	while(1) {
		...
		*Cycle =
		*/
		arm_convolve_HWC_uint8_asym_fast(tensorIn, CONV1_IM_DIM, CONV1_IM_CH,
		...
		*Cycle =
		*/
		arm_depthwise_separable_conv_HWC_uint8_asym(tensorIn, CONV2_IM_DIM, CONV2_IM_CH,
		...
		*Cycle =
		*/
		arm_convolve_HWC_uint8_asym_fast(tensorIn, CONV3_IM_DIM, CONV3_IM_CH,
		...
		*Cycle =
		*/
		arm_depthwise_separable_conv_HWC_uint8_asym(tensorIn, CONV4_IM_DIM, CONV4_IM_CH,
		...
		*Cycle =
		*/
		arm_convolve_HWC_uint8_asym_fast(tensorIn, CONV5_IM_DIM, CONV5_IM_CH,
		...
		*Cycle =
		*/
		arm_depthwise_separable_conv_HWC_uint8_asym(tensorIn, CONV6_IM_DIM, CONV6_IM_CH,
		...
		*Cycle =
		*/
		arm_convolve_HWC_uint8_asym_fast(tensorIn, CONV7_IM_DIM, CONV7_IM_CH,
		...
		*Cycle =
		*/
		arm_depthwise_separable_conv_HWC_uint8_asym(tensorIn, CONV8_IM_DIM, CONV8_IM_CH,
		...
		*Cycle =
		*/
		arm_convolve_HWC_uint8_asym_fast(tensorIn, CONV9_IM_DIM, CONV9_IM_CH,
		...
		*Cycle =
		*/
		arm_depthwise_separable_conv_HWC_uint8_asym(tensorIn, CONV10_IM_DIM, CONV10_IM_CH,
		...
		*Cycle =
		*/
		arm_convolve_HWC_uint8_asym_fast(tensorIn, CONV11_IM_DIM, CONV11_IM_CH,
		...
		*Cycle =
		*/
		arm_depthwise_separable_conv_HWC_uint8_asym(tensorIn, CONV12_IM_DIM, CONV12_IM_CH,
		...
		*Cycle =
		*/
		arm_convolve_HWC_uint8_asym_fast(tensorIn, CONV13_IM_DIM, CONV13_IM_CH,
		...
		*Cycle =
		*/
		arm_depthwise_separable_conv_HWC_uint8_asym(tensorIn, CONV14_IM_DIM, CONV14_IM_CH,
		...
		*Cycle =
		*/
		arm_convolve_HWC_uint8_asym_fast(tensorIn, CONV15_IM_DIM, CONV15_IM_CH,
		...
		*Cycle =
		*/
		arm_depthwise_separable_conv_HWC_uint8_asym(tensorIn, CONV16_IM_DIM, CONV16_IM_CH,
		...
		*Cycle =
		*/
		arm_convolve_HWC_uint8_asym_fast(tensorIn, CONV17_IM_DIM, CONV17_IM_CH,
		...
		*Cycle =
		*/
		arm_depthwise_separable_conv_HWC_uint8_asym(tensorIn, CONV18_IM_DIM, CONV18_IM_CH,
		...
		*Cycle =
		*/
		arm_convolve_HWC_uint8_asym_fast(tensorIn, CONV19_IM_DIM, CONV19_IM_CH,
		...
		*Cycle =
		*/
		arm_depthwise_separable_conv_HWC_uint8_asym(tensorIn, CONV20_IM_DIM, CONV20_IM_CH,
		...
		*Cycle =
		*/
		arm_convolve_HWC_uint8_asym_fast(tensorIn, CONV21_IM_DIM, CONV21_IM_CH,
		...
		*Cycle =
		*/
		arm_depthwise_separable_conv_HWC_uint8_asym(tensorIn, CONV22_IM_DIM, CONV22_IM_CH,
		...
		*Cycle =
		*/
		arm_convolve_HWC_uint8_asym_fast(tensorIn, CONV23_IM_DIM, CONV23_IM_CH,
		...
		*Cycle =
		*/
		arm_depthwise_separable_conv_HWC_uint8_asym(tensorIn, CONV24_IM_DIM, CONV24_IM_CH,
		...
		*Cycle =
		*/
		arm_convolve_HWC_uint8_asym_fast(tensorIn, CONV25_IM_DIM, CONV25_IM_CH,
		...
		*Cycle =
		*/
		arm_depthwise_separable_conv_HWC_uint8_asym(tensorIn, CONV26_IM_DIM, CONV26_IM_CH,
		...
		*Cycle =
		*/
		arm_convolve_HWC_uint8_asym_fast(tensorIn, CONV27_IM_DIM, CONV27_IM_CH,
