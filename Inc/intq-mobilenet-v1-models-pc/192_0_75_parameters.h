#ifndef __192_0_75_PARAMETERS_H__
#define __192_0_75_PARAMETERS_H__


/* Layer 1 Topology Parameters */
#define CONV1_IM_DIM    	(192)
...
#define CONV1_OUT_DIM    	(96)


/* Layer 2 Topology Parameters */
#define CONV2_IM_DIM    	(96)
...
#define CONV2_OUT_DIM    	(96)


/* Layer 3 Topology Parameters */
#define CONV3_IM_DIM    	(96)
...
#define CONV3_OUT_DIM    	(96)


/* Layer 4 Topology Parameters */
#define CONV4_IM_DIM    	(96)
#define CONV4_IM_CH     	(48)
...
#define CONV4_OUT_CH    	(48)
#define CONV4_OUT_DIM    	(48)


/* Layer 5 Topology Parameters */
#define CONV5_IM_DIM    	(48)
...
#define CONV5_OUT_CH    	(96)
#define CONV5_OUT_DIM    	(48)


/* Layer 6 Topology Parameters */
#define CONV6_IM_DIM    	(48)
#define CONV6_IM_CH     	(96)
...
#define CONV6_OUT_CH    	(96)
#define CONV6_OUT_DIM    	(48)


/* Layer 7 Topology Parameters */
#define CONV7_IM_DIM    	(48)
#define CONV7_IM_CH     	(96)
...
#define CONV7_OUT_CH    	(96)
#define CONV7_OUT_DIM    	(48)


/* Layer 8 Topology Parameters */
#define CONV8_IM_DIM    	(48)
#define CONV8_IM_CH     	(96)
...
#define CONV8_OUT_CH    	(96)
#define CONV8_OUT_DIM    	(24)


/* Layer 9 Topology Parameters */
#define CONV9_IM_DIM    	(24)
#define CONV9_IM_CH     	(96)
...
#define CONV9_OUT_CH    	(192)
#define CONV9_OUT_DIM    	(24)


/* Layer 10 Topology Parameters */
#define CONV10_IM_DIM    	(24)
#define CONV10_IM_CH     	(192)
...
#define CONV10_OUT_CH    	(192)
#define CONV10_OUT_DIM    	(24)


/* Layer 11 Topology Parameters */
#define CONV11_IM_DIM    	(24)
#define CONV11_IM_CH     	(192)
...
#define CONV11_OUT_CH    	(192)
#define CONV11_OUT_DIM    	(24)


/* Layer 12 Topology Parameters */
#define CONV12_IM_DIM    	(24)
#define CONV12_IM_CH     	(192)
...
#define CONV12_OUT_CH    	(192)
#define CONV12_OUT_DIM    	(12)


/* Layer 13 Topology Parameters */
#define CONV13_IM_DIM    	(12)
#define CONV13_IM_CH     	(192)
...
#define CONV13_OUT_CH    	(384)
#define CONV13_OUT_DIM    	(12)


/* Layer 14 Topology Parameters */
#define CONV14_IM_DIM    	(12)
#define CONV14_IM_CH     	(384)
...
#define CONV14_OUT_CH    	(384)
#define CONV14_OUT_DIM    	(12)


/* Layer 15 Topology Parameters */
#define CONV15_IM_DIM    	(12)
#define CONV15_IM_CH     	(384)
...
#define CONV15_OUT_CH    	(384)
#define CONV15_OUT_DIM    	(12)


/* Layer 16 Topology Parameters */
#define CONV16_IM_DIM    	(12)
#define CONV16_IM_CH     	(384)
...
#define CONV16_OUT_CH    	(384)
#define CONV16_OUT_DIM    	(12)


/* Layer 17 Topology Parameters */
#define CONV17_IM_DIM    	(12)
#define CONV17_IM_CH     	(384)
...
#define CONV17_OUT_CH    	(384)
#define CONV17_OUT_DIM    	(12)


/* Layer 18 Topology Parameters */
#define CONV18_IM_DIM    	(12)
#define CONV18_IM_CH     	(384)
...
#define CONV18_OUT_CH    	(384)
#define CONV18_OUT_DIM    	(12)


/* Layer 19 Topology Parameters */
#define CONV19_IM_DIM    	(12)
#define CONV19_IM_CH     	(384)
...
#define CONV19_OUT_CH    	(384)
#define CONV19_OUT_DIM    	(12)


/* Layer 20 Topology Parameters */
#define CONV20_IM_DIM    	(12)
#define CONV20_IM_CH     	(384)
...
#define CONV20_OUT_CH    	(384)
#define CONV20_OUT_DIM    	(12)


/* Layer 21 Topology Parameters */
#define CONV21_IM_DIM    	(12)
#define CONV21_IM_CH     	(384)
...
#define CONV21_OUT_CH    	(384)
#define CONV21_OUT_DIM    	(12)


/* Layer 22 Topology Parameters */
#define CONV22_IM_DIM    	(12)
#define CONV22_IM_CH     	(384)
...
#define CONV22_OUT_CH    	(384)
#define CONV22_OUT_DIM    	(12)


/* Layer 23 Topology Parameters */
#define CONV23_IM_DIM    	(12)
#define CONV23_IM_CH     	(384)
...
#define CONV23_OUT_CH    	(384)
#define CONV23_OUT_DIM    	(12)


/* Layer 24 Topology Parameters */
#define CONV24_IM_DIM    	(12)
#define CONV24_IM_CH     	(384)
...
#define CONV24_OUT_CH    	(384)
#define CONV24_OUT_DIM    	(6)


/* Layer 25 Topology Parameters */
#define CONV25_IM_DIM    	(6)
#define CONV25_IM_CH     	(384)
...
#define CONV25_OUT_CH    	(768)
#define CONV25_OUT_DIM    	(6)


/* Layer 26 Topology Parameters */
#define CONV26_IM_DIM    	(6)
#define CONV26_IM_CH     	(768)
...
#define CONV26_OUT_CH    	(768)
#define CONV26_OUT_DIM    	(6)


/* Layer 27 Topology Parameters */
#define CONV27_IM_DIM    	(6)
#define CONV27_IM_CH     	(768)
...
#define CONV27_OUT_CH    	(768)
#define CONV27_OUT_DIM    	(6)


/* Layer 28 Topology Parameters */
#define FC28_IM_CH     	(768)
#define FC28_OUT_CH    	(1000)


#endif /*__192_0_75_PARAMETERS_H__*/
